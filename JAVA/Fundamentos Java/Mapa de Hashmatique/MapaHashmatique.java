...
public class MapaHashmatique {
    public static void hashmatiqueMap() {
        HashMap<String, String> trackList = new HashMap<String, String>();
        trackList.put("Amanecer - Ysy A", """
        ...
        trackList.put("Corrito pa las animas", """
                Los ojito' en China
        ...
        trackList.put("Bohemian Rhapsody", """
        ...
        System.out.println("Cancion obtenida por su titulo: \n" + trackList.get("Tu sin mi"));
